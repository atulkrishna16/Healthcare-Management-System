...
import { Mail, Lock, User, ArrowRight, UserPlus, HeartPulse } from 'lucide-react';
        ...
        <div className="bg-white/95 backdrop-blur-sm border border-[#7AAACE]/60 rounded-3xl p-8 sm:p-10 shadow-[0_10px_25px_-3px_rgba(53,88,114,0.15)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <User size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#7AAACE]" />
                <input
                  type="text"
          ...
          <div className="mt-6 pt-6 border-t border-[#7AAACE]/30 text-center">
            <p className="text-xs text-[#4A6478]">
              ...
              <Link to="/login" className="font-bold text-[#355872] hover:underline">
                Sign In
              </Link>
            </p>
          </div>
