...
import { ShieldCheck, LayoutDashboard, Users, Bell, LogOut, Lock } from 'lucide-react';
...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F8F0] text-[#355872] flex flex-col md:flex-row">
      {/* Admin Sidebar — Solid Ink (#355872) Background */}
      <aside className="w-full md:w-64 bg-[#355872] p-5 flex flex-col justify-between shrink-0 shadow-[4px_0_20px_rgba(53,88,114,0.1)]">
        <div>
          ...
          <nav className="space-y-1">
            ...
            >
              <Users size={17} />
              <span>Physicians & Rostering</span>
            </NavLink>
      ...
      {/* Main Admin Content — Warm Paper Background (#F7F8F0) */}
